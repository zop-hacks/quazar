...
export const ClientAnswerOption = ({
  answer,
  index,
  isSelected,
  onSelect,
  ...
  return (
    ...
    >
      <Button
        className={`w-full h-auto py-4 px-5 text-left flex items-center text-white bg-gradient-to-r ${
        ...
        disabled={disabled}
      >
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-white flex items-center justify-center font-bold text-lg mr-3 text-current border border-current shadow-sm text-zinc-800">
          {answerLabels[index]}
        </div>
