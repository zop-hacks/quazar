  ...
  const agents = [
    {
      ...
      color: "border-purple-200 bg-purple-50 /30 /20",
    },
    {
      ...
      color: "border-indigo-200 bg-indigo-50 /30 /20",
    },
    {
      ...
      color: "border-blue-200 bg-blue-50 /30 /20",
    },
    {
      ...
      color: "border-amber-200 bg-amber-50 /30 /20",
    },
    {
      ...
      color: "border-emerald-200 bg-emerald-50 /30 /20",
    },
    {
      ...
      color: "border-rose-200 bg-rose-50 /30 /20",
    },
  ];
    ...
    <section className="bg-white py-16 ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center rounded-full bg-purple-100 px-3 py-1 text-sm font-medium text-purple-800 /30 ">
          ...
          <p className="mt-4 text-lg text-zinc-600 ">
            Quazar uses a sophisticated system of specialized AI agents that
            collaborate to create high-quality, educational quiz content.
          </p>
        </div>
            ...
            >
              ...
              >
                <CardContent className="p-6">
                  <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-white shadow-sm ">
                    {agent.icon}
                  </div>
                  <h3 className="mb-3 text-xl font-bold text-zinc-900 ">
                    {agent.title}
                  </h3>
                  <p className="text-zinc-600 ">{agent.description}</p>
                </CardContent>
              </Card>
            </motion.div>
          ))}
        ...
        <div className="mt-12 rounded-xl border border-zinc-200 bg-zinc-50 p-6  ">
          <div className="flex flex-col items-center text-center md:flex-row md:text-left">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-purple-100 text-purple-600 /30  md:mb-0 md:mr-6">
            ...
            <div>
              ...
              <p className="text-zinc-600 ">
                Our multi-agent system includes built-in redundancy and fallback
                mechanisms. If any question doesn't meet our quality standards,
                agents like Nan automatically create replacements, ensuring you
                always receive the highest quality quiz content possible.
              </p>
            </div>
          </div>
        </div>
