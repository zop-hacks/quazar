...
export function HeroSection() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-zinc-100 to-white py-20  ">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <div className="mb-6 inline-flex items-center rounded-full bg-zinc-100 px-3 py-1 text-sm font-medium text-zinc-800  ">
          ...
          <motion.h1
            className="mb-6 text-4xl font-extrabold tracking-tight text-zinc-900 sm:text-5xl md:text-6xl "
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="mx-auto mb-10 max-w-2xl text-xl text-zinc-600 "
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="mt-6 flex items-center justify-center space-x-2 text-sm text-zinc-500 "
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
